...
@Command(name = "fetch-lists", description = "Fetches a page of lists", mixinStandardHelpOptions = true)
public class FetchListsCommand implements Runnable {
	...
	public void run() {
		try {
			HttpResponse<Map<?, ?>> response = client.getLists(pageNumber);
