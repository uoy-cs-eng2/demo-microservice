...
@Command(name = "fetch-items", description = "Fetches a page of items", mixinStandardHelpOptions = true)
public class FetchItemsCommand implements Runnable {
	...
	public void run() {
		try {
			HttpResponse<Map<?, ?>> response = client.getItems(pageNumber);
